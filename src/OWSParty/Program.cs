...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Party Authentication API", Version = "v1" });
    ...
    var filePath = Path.Combine(System.AppContext.BaseDirectory, "OWSParty.xml");
    c.IncludeXmlComments(filePath);
});


container.Register<PartyService>();
...
app.UseSwaggerUI(c =>
{
    ...
    c.SwaggerEndpoint("./v1/swagger.json", "Party Authentication API");
});

app.MapGrpcService<PartyService>();
