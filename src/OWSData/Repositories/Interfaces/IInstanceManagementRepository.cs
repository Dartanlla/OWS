...
namespace OWSData.Repositories.Interfaces
{
    public interface IInstanceManagementRepository
    {
        ...
        Task<GetServerInstanceFromPort> GetServerInstanceFromPort(Guid customerGUID, IPAddress serverIP, int port);
        ...
        Task<SuccessAndErrorMessage> RegisterLauncher(Guid customerGUID, string launcherGuid, IPAddress serverIp, int maxNumberOfInstances, IPAddress internalServerIp, int startingInstancePort);
