...
namespace OWSData.Models.Tables
{
    ...
    public record Characters(
        ...
        double MaxFatigue,
        double Fatigue,
        double FatigueRegenRate,
        double MaxStamina,
        double Stamina,
        double StaminaRegenRate,
        double MaxEndurance,
        double Endurance,
        double EnduranceRegenRate,
        double Strength,
        double Dexterity,
        double Constitution,
        double Intellect,
        ...
        double Alignment,
        string Description,
        string DefaultPawnClassPath,
        bool IsInternalNetworkTestUser,
        int ClassId,
        string BaseMesh
        )
    {
        public ICollection<CharHasAbilities> CharHasAbilities { get; set; } = new HashSet<CharHasAbilities>();
        public ICollection<CharHasItems> CharHasItems { get; set; } = new HashSet<CharHasItems>();
        public ICollection<CustomCharacterData> CustomCharacterData { get; set; } = new HashSet<CustomCharacterData>();
    }
