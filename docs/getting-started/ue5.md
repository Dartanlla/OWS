---
layout: default
title: Unreal Engine 5.0.2
parent: OWS Starter Project
grand_parent: Getting Started
nav_order: 1
---

# OWS Starter Project for Unreal Engine 5.0.2
Follow these instructions if you want to setup the OWS Starter Project for Unreal Engine 5.0.2. Before you are able to setup this project you need to finish the [Docker Setup](docker-setup) and [Database setup](setup-database) sections.

## Download the project

Click on the button below to download the Open World Starter project.

[Download OpenWorldStarterDockerUE5.zip - 20220612 Release - UE 5.0.2](https://drive.google.com/file/d/1W4Rh_CPzKeC-QKU8-viYUNG0gVljsSkZ/view?usp=sharing){: .btn .btn-blue .mr-4}
