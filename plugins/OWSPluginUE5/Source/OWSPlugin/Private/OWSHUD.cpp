	...
	const int32 UIHeight)
{
	...
	float OffsetXMinusUIWidthDividedBy2 = OffsetX - (UIWidth / 2);
	float OffsetYMinusUIHeightDividedBy2 = OffsetY - (UIHeight / 2);
	float ScreenCenterXplusOffsetXMinusUIWidthDividedBy2 = ScreenCenterX + OffsetXMinusUIWidthDividedBy2;
	float ScreenCenterYplusOffsetYMinusUIHeightDividedBy2 = ScreenCenterY + OffsetYMinusUIHeightDividedBy2;
	float CanvasSizeXplusOffsetXMinusUIWidthDividedBy2 = Canvas->SizeX + OffsetXMinusUIWidthDividedBy2;
	float CanvasSizeYplusOffsetYMinusUIHeightDividedBy2 = Canvas->SizeY + OffsetYMinusUIHeightDividedBy2;
	...
	case EAnchorPoint::TopLeft:
		...
		case EAnchorPoint::TopCenter:
			OutScreenPosition.X = FMath::FloorToInt(OffsetXMinusUIWidthDividedBy2);
			OutScreenPosition.Y = OffsetY;
			break;
		...
		case EAnchorPoint::MiddleLeft:
			OutScreenPosition.X = OffsetX;
			OutScreenPosition.Y = FMath::FloorToInt(OffsetYMinusUIHeightDividedBy2);
			break;
	...
	case EAnchorPoint::TopCenter:
		...
		case EAnchorPoint::TopLeft:
			...
			break;
		case EAnchorPoint::TopCenter:
			OutScreenPosition.X = FMath::FloorToInt(ScreenCenterXplusOffsetXMinusUIWidthDividedBy2);
			OutScreenPosition.Y = OffsetY;
			break;
		case EAnchorPoint::TopRight:
	...
	case EAnchorPoint::MiddleLeft:
		...
		case EAnchorPoint::MiddleLeft:
			OutScreenPosition.X = OffsetX;
			OutScreenPosition.Y = FMath::FloorToInt(ScreenCenterYplusOffsetYMinusUIHeightDividedBy2);
			break;
		case EAnchorPoint::BottomLeft:
			OutScreenPosition.X = OffsetX;
	...
	case EAnchorPoint::MiddleRight:
		...
		case EAnchorPoint::TopLeft:
			...
			break;
		case EAnchorPoint::TopCenter:
			OutScreenPosition.X = FMath::FloorToInt(CanvasSizeXplusOffsetXMinusUIWidthDividedBy2);
			OutScreenPosition.Y = ScreenCenterY + OffsetY;
			break;
		case EAnchorPoint::TopRight:
	...
	case EAnchorPoint::BottomLeft:
		...
		case EAnchorPoint::MiddleLeft:
			OutScreenPosition.X = OffsetX;
			OutScreenPosition.Y = FMath::FloorToInt(CanvasSizeYplusOffsetYMinusUIHeightDividedBy2);
			break;
		case EAnchorPoint::MiddleCenter:
			OutScreenPosition.X = FMath::FloorToInt(OffsetXMinusUIWidthDividedBy2);
			OutScreenPosition.Y = FMath::FloorToInt(CanvasSizeYplusOffsetYMinusUIHeightDividedBy2);
	...
	case EAnchorPoint::BottomCenter:
		...
		case EAnchorPoint::TopLeft:
			...
			break;
		case EAnchorPoint::TopCenter:
			OutScreenPosition.X = ScreenCenterX + FMath::FloorToInt(OffsetXMinusUIWidthDividedBy2);
			OutScreenPosition.Y = Canvas->SizeY + OffsetY;
			break;
		case EAnchorPoint::TopRight:
			OutScreenPosition.X = ScreenCenterX + OffsetX - UIWidth;
...
void AOWSHUD::AddSlotsToSkip(TSet<int32> &SlotsToSkip, const int32 SlotNumber, const int32 ItemSlotWidth, const int32 ItemSlotHeight, const int32 NumberOfColumns)
{
	...
	float SlotNumberDividedByNumberOfColumns = SlotNumber / NumberOfColumns;
	int32 StartingRow = FMath::FloorToInt(SlotNumberDividedByNumberOfColumns);
			...
			if (Inventory)
			{
				...
				if (InventoryItemStack)
				{
					...
					if (ItemToStartDragging)
					{
						...
						{
							float SlotNumberDividedByNumberOfColumns = Slot / Inventory->NumberOfColumns;
							int32 StartingRow = FMath::FloorToInt(SlotNumberDividedByNumberOfColumns);
